...
#include "ofMain.h"
#include "BasicParticle.h"      //include our BasicParticle object header
...
class ofApp : public ofBaseApp{
    ...
    vector <BasicParticle> particles;       //Create a vector of particles. Similar to our Java ArrayList
